...
class Testmock (unittest.TestCase):
    ...
    def test_08_abrir_regras_ok(self):
        m = mock.Mock()
        print("Caso de teste 08 - Abrir a tela de regras")
        m.abre_regras.return_value = 0
        self.assertEqual(m.abre_regras(), 0)

    def test_09_abrir_regras_falha(self):
        m = mock.Mock()
        print("Caso de teste 09 - Abrir tela de Regras falhou")
    ...
    def test_17_exibir_vencedor_falha(self):
        m = mock.Mock()
        print("Caso de teste 17 - exibir o vencedor de uma partida")
        m.exibe_vencedor.return_value = 1
        self.assertEqual(m.exibe_vencedor(), 1)

    def test_18_abre_menu_ok(self):
        m = mock.Mock()
        print("Caso de teste 18 - abrir o menu após o final de uma partida")
