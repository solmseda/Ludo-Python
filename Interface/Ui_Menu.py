...
"")
        ...
        self.verticalLayout_2.addWidget(self.imageTitle)
        self.horizontalLayout.addWidget(self.imageLayout)
...
"}")
        ...
        self.spinBoxNumPlayers.setMinimumSize(QtCore.QSize(100, 0))
